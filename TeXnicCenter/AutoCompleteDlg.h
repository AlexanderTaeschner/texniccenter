...
private:
	...
	void ApplySelection(const TCHAR AdditionalInsertChar = _T('\0'));
...
public:
	/**
	        ...
	        or an environment).
	 */
	virtual void OnACCommandSelect(const CLaTeXCommand* cmd, const TCHAR AdditionalInsertChar = _T('\0')) = 0;
	/**
